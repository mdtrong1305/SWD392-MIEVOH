    ...
    return (
        <div className="max-w-4xl mx-auto py-8 animate__animated animate__zoomIn">
            <div className="bg-white dark:bg-zinc-900/50 border border-slate-150 dark:border-zinc-800/80 rounded-[2.5rem] shadow-xl overflow-hidden relative flex flex-col md:flex-row">
                ...
                <div className="absolute top-0 right-80 w-8 h-8 rounded-full bg-[#EFEBF4] -mt-4 border-b border-slate-150/70 dark:border-zinc-800/80 z-20 hidden md:block" />
                <div className="absolute bottom-0 right-80 w-8 h-8 rounded-full bg-[#EFEBF4] -mb-4 border-t border-slate-150/70 dark:border-zinc-800/80 z-20 hidden md:block" />

                {/* Left Side: Ticket Main Body */}
                <div className="flex-1 p-8 md:p-10 text-left flex flex-col justify-between border-b md:border-b-0 md:border-r border-dashed border-slate-200 dark:border-zinc-800/80">
                    <div>
                        <div className="flex items-center gap-4.5 mb-6">
                            {/* Success Checkmark */}
                            <div className="w-12 h-12 rounded-full bg-emerald-50 dark:bg-emerald-950/30 border-4 border-emerald-100 dark:border-emerald-900/30 flex items-center justify-center text-emerald-500 animate__animated animate__bounceIn">
                        ...
                        <div className="flex gap-6 items-start pb-6 border-b border-slate-100 dark:border-zinc-800/60">
                            <div className="w-20 h-28 rounded-xl overflow-hidden shrink-0 shadow-md">
                                <img src={movie.image} alt={movie.title} className="w-full h-full object-cover" />
                            </div>
                            <div className="flex-1 space-y-2.5">
                                <h3 className="font-black text-xl text-slate-850 dark:text-white leading-snug">{movie.title}</h3>
                ...
                <div className="w-full md:w-80 bg-slate-50/50 dark:!bg-[#18181b]/50 p-8 md:p-10 flex flex-col items-center justify-between text-center relative shrink-0 pt-10 md:pt-14">
                    <div className="w-full flex flex-col items-center space-y-6 my-auto">
                        {/* Horizontal Barcode */}
                        <div className="bg-white dark:!bg-white px-4 py-6.5 rounded-3xl shadow-sm border border-slate-150/80 dark:border-slate-200/80 flex flex-col items-center justify-center w-full">
                            <svg className="w-full h-24 !text-black" viewBox="0 0 200 50" fill="currentColor" preserveAspectRatio="none">
