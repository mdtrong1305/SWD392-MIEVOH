        ...
        <div className="max-w-4xl mx-auto py-6 animate__animated animate__fadeIn w-full">
            {isVerifying && (
                <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/60 text-white">
                    <Loader2 className="h-12 w-12 text-[#8E7EFE] animate-spin mb-4" />
            ...
            <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-xl overflow-hidden p-8 md:p-10">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
                    {/* Left Column: Bank account details */}
                    <div className="md:col-span-3 space-y-6">
                        <div className="border-b border-slate-100 pb-5 text-left">
                            <h2 className="text-xl font-black text-slate-850">Transfer money to the following account</h2>
                            <p className="text-sm font-semibold text-slate-500 mt-2 leading-relaxed">
                                You need to transfer within{" "}
                                <span className="text-[#E13D53] font-black text-base tracking-wider bg-rose-50 px-2.5 py-1 rounded-xl">
                        ...
                        <div className="space-y-1">
                            <div className="py-3.5 border-b border-slate-100/80 flex flex-col items-start gap-1">
                                <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Bank</span>
                                <span className="text-slate-800 font-extrabold text-base text-left">Military Commercial Joint Stock Bank (MB Bank)</span>
                            </div>
                            
                            <div className="py-3.5 border-b border-slate-100/80 flex flex-col items-start gap-1">
                                <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Account Number</span>
                                <div className="flex items-center justify-between w-full">
                                    <span className="text-slate-800 font-extrabold text-base tracking-wider">86870029</span>
                                    <button 
                                        onClick={() => {
                                            navigator.clipboard.writeText("86870029");
                                            toast.success("Account number copied!");
                                        }}
                                        className="px-3 py-1.5 rounded-xl bg-violet-50 hover:bg-violet-100 text-[#8E7EFE] transition-colors cursor-pointer flex items-center justify-center gap-1.5 text-xs font-bold"
                                    >
                            ...
                            <div className="py-3.5 border-b border-slate-100/80 flex flex-col items-start gap-1">
                                ...
                                <span className="text-slate-800 font-extrabold text-base">CONG TY TNHH MONET</span>
                            </div>
                            
                            <div className="py-3.5 border-b border-slate-100/80 flex flex-col items-start gap-1">
                                <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Transfer Content</span>
                                <div className="flex items-center justify-between w-full">
                                    <span className="text-slate-800 font-extrabold text-base tracking-widest bg-violet-50/50 px-2 py-0.5 rounded text-[#8E7EFE]">{bookingCode}</span>
                                    <button 
                                        onClick={() => {
                            ...
                            <div className="py-3.5 border-b border-slate-100/80 flex flex-col items-start gap-1">
                                ...
                                <span className="text-slate-850 font-black text-xl text-[#8E7EFE]">{formatPrice(totalPrice)}</span>
                            </div>
                        </div>
                        
                        <div className="text-left space-y-1.5 text-xs font-bold text-slate-500 pt-2 leading-relaxed">
                            <p className="text-[#E13D53]">The system automatically issues the ticket code within 30s after your successful transfer.</p>
                            <p>Please contact hotline <span className="text-[#8E7EFE] font-black">024 7308 8890</span> if you do not receive the ticket code.</p>
                        </div>
                        
                        <div className="pt-4 flex gap-4">
                            <button 
                                onClick={() => setShowQRTransfer(false)}
                                className="px-6 py-3.5 border border-slate-200 hover:border-slate-355 hover:bg-slate-50 text-slate-650 hover:text-slate-800 font-extrabold text-sm rounded-2xl transition-all cursor-pointer"
                            >
                                Cancel Transaction
                            </button>
                            <button 
                                ...
                                className="flex-1 py-3.5 bg-[#8E7EFE] hover:bg-[#7d6dfc] text-white font-extrabold text-sm rounded-2xl transition-all cursor-pointer shadow-lg shadow-violet-100 text-center"
                            >
                    ...
                    <div className="md:col-span-2 flex flex-col items-center justify-center border-t md:border-t-0 md:border-l border-slate-100 pt-8 md:pt-0 md:pl-8">
                        <div className="flex flex-col items-center mb-6">
                            <div className="flex items-center justify-center gap-0.5 text-lg font-black italic tracking-tight">
                                ...
                                <span className="text-[#0F3B84] text-2xl ml-0.5">QR</span>
                            </div>
                        </div>
                        
                        <div className="bg-white p-4 rounded-3xl shadow-md border border-slate-100/90 flex flex-col items-center">
                            <img 
                        ...
                        <div className="flex items-center justify-center gap-4 mt-6 border-t border-slate-100 pt-4 w-full">
